...
python3.7 workload.py --model 'AlexNet' --dataset 128 --batch_size 64    
python3.7 workload.py --model 'InceptionV3' --dataset 128 --batch_size 64    
python3.7 workload.py --model 'InceptionResNetV2' --dataset 128 --batch_size 64    
...
python3.7 workload.py --model 'AlexNet' --dataset 224 --batch_size 128    
python3.7 workload.py --model 'InceptionV3' --dataset 224 --batch_size 128    
python3.7 workload.py --model 'InceptionResNetV2' --dataset 224 --batch_size 128    
