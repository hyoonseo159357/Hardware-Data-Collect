...
ssh -o ServerAliveInterval=300 -i $AWS_KEY -t ubuntu@$INSTANCE_DNS 'cd /home/ubuntu/Hardware-Data2/;sudo bash ./settings.sh'

# Run Experiments
sleep 60
echo 'start experiment'
ssh -o ServerAliveInterval=300 -i $AWS_KEY -t ubuntu@$INSTANCE_DNS 'cd /home/ubuntu/Hardware-Data2/;sudo bash ./run_all.sh'
